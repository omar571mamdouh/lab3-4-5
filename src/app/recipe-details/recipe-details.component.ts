import { CommonModule, DatePipe, NgClass, NgFor, UpperCasePipe } from '@angular/common';
...
@Component({
  ...
  imports: [CommonModule, UpperCasePipe, DatePipe ,NgClass,NgFor], 
...
export class RecipeDetailsComponent {
  ...
  ngOnInit() {
    this.ProductRequestService.getProductDetailsrequest(this.id).subscribe((response) => this.productdetails = response);
